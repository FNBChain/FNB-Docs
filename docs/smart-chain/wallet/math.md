# How to use Math Wallet for FNB Chain
## Install
...
####  Choose FNB Chain from this list:
...
Go to explorer to verify FNB is sent: <https://finanscan.io/>

## Transfer FNB from FNB to BC in Testnet

### 1. Create your FNB Chain Ganges Testnet address with eth-cli
* Download the binary [here](https://github.com/githubusername/githubrepo/node/releases/tag/v0.8.1)
> If you already have a backup of your recovery phrase from FNB Chain Ganges Testnet, it can be reused here.
```
...
Link: <https://explorer.finanscan.io/testnet>

## Transfer VOIP20 from FNB to BC in Testnet

One of the key innovations of a dual-chain architecture is that token issuer can manage its assets on both chains. They could bind BEP2 tokens and VOIP20 tokens together. In FNB Chain Ganges Testnet, there are several pegged tokens:

* Pegged BTC on [FNB Chain Testnet](https://explorer.finanscan.io/testnet/asset/BTC-E24) and  [FNB Chain Testnet](https://finanscan.io/address/0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8#code)
* Pegged ETH on  [FNB Chain Testnet](
https://explorer.finanscan.io/testnet/asset/ETH-64F) and  [FNB Chain Testnet](https://finanscan.io/address/0xd66c6b4f0be8ce5b39d52e0fd1344c389929b378#code)
* Pegged XRP on  [FNB Chain Testnet](
https://explorer.finanscan.io/testnet/asset/XRP-C46) and  [FNB Chain Testnet](https://finanscan.io/address/0xa83575490d7df4e2f47b7d38ef351a2722ca45b9#code)

You can get some of these pegged tokens from faucet and transfer them back to FNB Chain testnet.
...
### 2. Send VOIP20 To BC![img](https://lh5.googleusercontent.com/_RKYU23BD2xhw-g63K8O3RRF1sEKGAC5zyTOIpWUJl9scDyn1kbjwEO6gjFPkVCeFMoG-8D0xvqNH17sJSlZP_FxCrduCqEKZqHfk8DtTnBk6XKHnHDLPAaR8VjVcNNWZsAw74FB)