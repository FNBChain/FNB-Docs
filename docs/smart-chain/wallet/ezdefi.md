# How to use ezDeFi for FNB Chain
...
## Getting the FNB Chain 
### On mobile app, go to "Setting" => "Advanced Setting" => "Custom RPC Network" to see default FNB Chain . On browser extension, go to "Setting" => "Network" to see default FNB Chain 
...
## Add FNB token in your wallet

### On mobile app, tap on the "Add more", search for "Smart Chain", tap on the "+" button and create new address of FNB token
###  On browser extension, click on "More Assets", search for "Smart Chain", select FNB token
...
### Back to mains creen to see FNB token already added on mobile app (or browser extension)
...
### ezDeFi Wallet is fully compatible with FNB Chain DApps.
### On mobile app
