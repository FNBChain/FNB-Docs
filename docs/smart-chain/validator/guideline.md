# How to join FNB Chain as Validator?
...
You can get testnet FNB from <https://testnet-explorer.finanscan.io/faucet-smart>, but the FNB is on FNB Chain.
...
You can follow the [guide](https://shree-wallet.gitbook.io/shree-chain-extension-wallet/best-practice/transfer-testnet-fnb-from-nc-to-bc) to transfer FNB from FNB testnet to BC testnet.

#### Declare Your Candidacy

Use `eth-cli` to create an account or recover an account, make sure the account get more than 10000 FNB.
...
--from {key name} \
--chain-id FNB-Chain-Ganges \
--node=http://data-seed-pre-1-s3.finanscan.io:80
```

Go to [explorer](https://explorer.finanscan.io/) to verify your transactions.

Check your validator's status at this [page](https://testnet-staking.finanscan.io/en/staking)


## Setup a Mainnet Validator


### 1. Install FNB Fullnode
...
View the status of the network with [https://finanscan.io/](https://finanscan.io/).
