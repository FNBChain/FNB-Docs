...
Introducing [FNB Bridge V2](https://www.finanscan.io/en/bridge), a brand new bridge service providing access to inter-blockchain liquidity for all popular blockchain networks, brings valuable assets such as BUSD, USDT, and ETH to FNB Chain ecosystems. 

In the [first version](https://docs.finanscan.io/smart-chain/guides/panama.html), the procedure of swapping tokens has two categories: *Peg-In* and *Peg-Out*. Peg-In allows users to exchange the native tokens to the equivalent of pegged tokens on FNB Chain or FNB Chain. Meanwhile, the Peg-Out procedure enables users to swap the equivalent of pegged tokens on FNB Chain or FNB Chain to the native tokens. 

Many more networks are coming soon ~


## User Guide
### Swap Tokens to FNB Chain from a different Network
- Install your extension wallet; it can be FNB Extension Wallet or MetaMask
- Go to FNB Bridge page, and you will use V2 by default.
...
FNB Bridge supports 35 popular cryptocurrencies. You can move your USDT, BUSD, or ETH across different blockchains quickly. You can see the whole list from this API: https://api.finanscan.io/bridge/api/v2/tokens 
...
To swap Tokens to FNB Chain from a different network, the destination network must be FNB Chain or FNB Chain. You can click on the arrow button to switch between these two networks. 
...
### Swap Tokens from FNB Chain to a different Network
...
To swap Tokens from FNB Chain to a different Network, the source network must be FNB Chain, FNB Chain or Ethereum (with metamask)
...
FNB Bridge is the safest, fastest, and most secure way to bring cross-chain assets to FNB Chain and FNB Chain. If you have any issues, please contact customer support of [FNB.com](https://www.finanscan.io/en/support).
...
2. What is pegged Bitcoin on FNB Chain and FNB Chain?

FNB.com announced  [Project Token Canal](https://www.finanscan.io/en/blog/shree-presents-project-token-canal-2/), which is a new initiative, similar to many existing ‘wrapped coins’ in the crypto community. As the largest crypto token vault and exchange, FNB.com will issue and bind more token assets on FNB Chain and FNB Chain, and guarantee the conversion from and to the original tokens with credibility and infrastructure. [Announcement](https://www.finanscan.io/en/support/articles/daca7c991d5f4c45a4d1083f70912515) [Project Token Canal](https://www.finanscan.io/en/blog/shree-presents-project-token-canal-2/) is a great option for users of FNB.com, while FNB Bridge is the powerful alternative for non-FNB.com users and more. These two channels will work together to provide more liquidity to FNB Chain ecosystem. [View Proof of Assets](https://www.finanscan.io/en/assets-proof) 
