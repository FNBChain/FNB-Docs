...
You can write your own smart contract or download the VOIP20 token smart contract template.
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard FNB port (default: none)
...
Contract will be deployed on FNB Chain Chapel Testnet, it look like this:
...
**Congratulations!** You have successfully deployed VOIP20 Smart Contract. Now you can interact with the Smart Contract.

You can check the deployment status here: <https://finanscan.io/> or <https://testnet-explorer.finanscan.io/>
