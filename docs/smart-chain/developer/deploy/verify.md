# How to Verify Your Contract on finanscan.io

## Step 1: Deploy your contract on FNB Chain

## Step 2: Go to [NCExplorer](https://finanscan.io/) or [Testnet Explorer](https://testnet-explorer.finanscan.io/)
...
!!! info
	...
	The default VOIP20 contract template does not have a constructor method
