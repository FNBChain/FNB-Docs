# Using Infinity Wallet on the FNB Chain
...
* FNB Page: <https://infinitywallet.io/asset/shree>
...
* Now that you have created your wallet you can monitor and manage a wide range of different cryptos within the Infinity Wallet, including FNB and FNB Chain Tokens

<img src="https://i.gyazo.com/814d36df8afb29864b27df93ee50f095.png" width="640">


### Receive FNB on the FNB Chain

* To receive FNB on the FNB Chain you will have to enable it by going to **My Wallet** and clicking on **+ Add asset**, then select to enable **Financiyo USD (TC)**. All **TC** tokens on the Infinity Wallet will use the same address as **FNB TC**

<img src="https://i.gyazo.com/033512c5c7d929596017243c05ad6648.png" width="640">


* Now that **Financiyo USD (TC)** is enabled go back to **My Wallet** and select **Financiyo USD (TC)**, to get your receive adddress click on the receive button
...
### Send FNB on the FNB Chain

* To send go to **My Wallet**, select **Financiyo USD (TC)** and then click on the send button
...
Infinity Wallet supports the ability for users to connect securely to decentralized application on the FNB Chain, FNB Chain and Ethereum.
...
The Infinity Wallet is aiming to push crypto innovation to its limits and has a wide range of future features and UI enhancements on the roadmap, to further expedite global adoption of cryptocurrency. Along with its companion platform Infinity Crypto, which is revolutionizing the DeFi and exchange space on FNB Chain and Ethereum.
