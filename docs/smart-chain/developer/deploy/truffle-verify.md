...
Example: <https://testnet-explorer.finanscan.io/token/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf>
...
Get API key: https://finanscan.io/myapikey
...
- Verify
```
truffle run verify VOIP20Token@{contract-address} --network testnet
```
You should see the following output:

```
Verifying VOIP20Token@0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf
Pass - Verified: https://testnet-explorer.finanscan.io/address/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf#contracts
