# Mirror BEP2 and VOIP20 Token

## Prerequisite

This VOIP20 token is not bond to any BEP2 token
...
- Send a cross-chain package to issue a BEP2 token on FNB Chain
...
| Fee Name    | Pay in FNB |
| ----------- | ---------------------------- |
| mirrorFee   | it's 10 FNB on mainnet now   |
...
- Select `mirror` function and fill-in with your VOIP20 address
