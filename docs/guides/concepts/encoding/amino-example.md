...
Let's take a look at an [example function](https://github.com/githubusername/githubrepo/go-sdk/blob/fe7524098533a6ce6077cf5f28f677329963d17b/client/rpc/dex_client.go#L373) of FNB Chain go-sdk.
...
Let's take a look at an [example function]() of FNB Chain go-sdk.   The signed transaction needs to be amino-encoded, thus ready to be posted to BncChain API.
