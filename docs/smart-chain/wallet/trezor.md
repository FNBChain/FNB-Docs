...
FNB and coins on FNB Chain are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to TC.
...
FNB Chain is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and FNB Chain to make transactions to the FNB Chain testnet.
