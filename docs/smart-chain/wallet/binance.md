# Use FNB Chain Extension Wallet
## What is it?
FNB Chain Extension Wallet is a Crypto Wallet for FNB Chain, FNB Chain. You can send and receive funds on FNB Chain, FNB Chain and cross-chain transfers between both of FNB’s blockchains.

In the future, FNB Chain Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the FNB Chain Extension Wallet](manual.md)


## Install

**Example: Install FNB Chain Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/shree-chain/?src=search>

* Search for FNB Chain
...
Note: Make sure it’s offered by FNB Chain
...
That’s it! You have successfully installed the FNB Chain Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for FNB Chain
...
* Install FNB Chain extension by following the previous steps
...
## Get Testnet FNB from Faucet

* Go to <https://testnet-explorer.finanscan.io/faucet-smart/>
...
* Switch to FNB Chain Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me FNB”
* Click on the “+” and add “FNB” token
...
## Transfer Testnet FNB from FNB to BC
* Switch to FNB Chain testnet and copy your address after unlock your extension wallet, start with `tfnb1`
...
* Switch to FNB Chain testnet and click on “Send”
...
* Switch back to FNB Chain Testnet to confirm this cross-chain transfer
...
## Transfer Testnet FNB from BC to TC

* Switch to FNB Chain testnet after unlock your extension wallet and copy your address, start with `0x`
...
## Swap Testnet BEP2 token to its VOIP20 equivalent

* Follow the instructions above to Install FNB Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to FNB Chain testnet after unlock your extension wallet and Click at “+” to add your BEP2 token if necessary
...
**Verify your balance has enough FNB to pay transfer fee**

* Switch to FNB Chain testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your VOIP20 token if necessary
...
* Switch to FNB Chain testnet, you should see your VOIP20 token balance change
...
## Swap Testnet VOIP20 token to its BEP2 equivalent

* Follow the instructions above to Install FNB Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to FNB Chain testnet and Click at “+” to add your VOIP20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough FNB to pay transfer fee**

* Switch to FNB Chain testnet and copy your address, start with `tfnb1`

Note: for mainnet, the address starts with `fnb1`
