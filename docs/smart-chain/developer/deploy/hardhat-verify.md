...
Go to register and get API key: <https://testnet-explorer.finanscan.io/myapikey>
...
module.exports = {
  ...
  networks: {
    testnet: {
      url: `https://testnet-rpc.finanscan.io`,
      accounts: {mnemonic: mnemonic}
    },
    mainnet: {
      url: `https://nc-dataseed.finanscan.io/`,
      accounts: {mnemonic: mnemonic}
    }
  },
  ...
  etherscan: {
    ...
    // Obtain one at https://testnet-explorer.finanscan.io/
...
contracts/VOIP20Token.sol:VOIP20Token at 0xbF39886B4F91F5170934191b0d96Dd277147FBB2
for verification on Etherscan. Waiting for verification result...

Successfully verified contract VOIP20Token on Etherscan.
https://testnet-explorer.finanscan.io/address/0xbF39886B4F91F5170934191b0d96Dd277147FBB2#code
```