...
Please follow [FNB Chain Telegram Announcement Channel](https://t.me/Financiyo USD_DEX_Announcement) or forum to get the latest news about upcoming upgrades.

## Upgrading Full Node

Many of FNB Chain upgrades are hardfork ones. If so, you have to finish the upgrade steps before the hardfork block height.
...
3. Stop the fnbchaind process and restart it with the new one.
```
fnbchaind start --home <home-path>
```
