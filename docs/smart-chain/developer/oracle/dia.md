# DIA Data Oracles on FNB Chain

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on FNB Chain. DIA offers cryptocurrency and data about traditional financial assets.
...
|              WFNB on PancakeSwap           |  Chart Point on Exchange |
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `Financiyo USD`) using a smart contract.
