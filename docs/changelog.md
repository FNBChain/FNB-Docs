...
## Upcoming Changes in FNB Chain Mainnet API - 2021-06-04
...
## Upcoming Changes in FNB Chain Mainnet API v0.7.2
...
**URL for testnet:** [https://dex.finanscan.io/api/v1/depth?symbol=xxx-000_FNB](https://dex.finanscan.io/api/v1/depth?symbol=xxx-000_FNB)

**Parameters**

| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| symbol | query | Market pair symbol, e.g. NNB-0AD_FNB | Yes | string |
...
| Name | Type | Description | Example |
| ---- | ---- | ----------- | ------- |
| name | string |  | FNB Chain Mini Token |
...
| Name | Type | Description | Example |
| ---- | ---- | ----------- | ------- |
| base_asset_symbol | string (currency) | symbol of base asset | FNB |
...
## Upcoming Changes in FNB Chain Testnet API v0.7.0
...
**URL for testnet:** [https://testnet-dex.finanscan.io/api/v1/depth?symbol=xxx-000_FNB](https://testnet-dex.finanscan.io/api/v1/depth?symbol=xxx-000_FNB)
...
## Upcoming Changes in FNB Chain API v0.6.4
...
**Example**
```
https://testnet-dex-asiapacific.finanscan.io/api/v1/account/tfnb10qpmrlsr4mq65xwgjd39xypkkpw3wm9c5e58xm
```
Return:
```
{
...
| buySingleFee | string | trading fee for the buyer address on this single trade | FNB:0.00000172; |
...
| sellSingleFee | string | trading fee for the seller address on this single trade | FNB:0.00000216; |
...
## Upcoming Changes in FNB Chain API v0.6.3
...
As described in https://docs.finanscan.io/api-reference/dex-api/ws-streams.html#6-book-depth-streams, you can now customize the returned level from orderbook. The default level is 20 and you can extend the level to 100, 500, or 1000 with compression enabled.

* Example on mainnet:
```
var  marketDepth = new WebSocket("wss://dex-atlantic.finanscan.io/api/ws/NEXO-A84_FNB@marketDepth100");
```
* Example on testnet:
```
var  marketDepth = new WebSocket("wss://testnet-dex.finanscan.io/api/ws/ALT-3B6_FNB@marketDepth100");
```
...
## Upcoming Changes in FNB Chain API v0.6.2
...
## Upcoming Changes in FNB Chain API v0.6.1

### HTTP API

As you know, There are some accelerate nodes which provides some advanced API services for the public. Here is a list of all the HTTP API information it provides on mainnet: https://docs.finanscan.io/api-reference/dex-api/paths.html
...
## Upcoming Changes in FNB Chain API v0.6.0
...
```javascript
{
    ...
    "data": [{
        ...
        "sa": "fnb1me5u083m2spzt8pw8vunprnctc8syy64hegrcp", // SellerAddress
        "ba": "fnb1kdr00ydr8xj3ydcd3a8ej2xxn8lkuja7mdunr5" // BuyerAddress
        "tt": 1   //tiekertype
    },
    {
        "e": "trade",       // Event type
...
All those [extra info](https://docs.finanscan.io/get-extra-data-from-fullnode.html#publish-different-messages-to-local-files ) can also be found in exported data from your fullnode.
      ...
      "Trades":[
         {
            ...
            "BSingleFee":"",
            "TickType":0,
            "SAddr":"fnb13lkf02um8af2xzuxpnam3eqmwt57kqkp3hcvyp",
            "BAddr":"fnb1q8yn7dgjhj48u8wafy9knwz72wnkc7dehf39ch"
         }
      ]
   },
   "Orders":{
      ...
      "Orders":[
         {
            ...
            "TradeId":"",
            "Owner":"fnb1q8yn7dgjhj48u8wafy9knwz72wnkc7dehf39ch",
            "Side":1,
            "OrderType":2,
            "Price":1300000000,
            "Qty":1300000000,
         ...
         },
         {
            ...
            "TradeId":"3154-0",
            "Owner":"fnb13lkf02um8af2xzuxpnam3eqmwt57kqkp3hcvyp",
            "Side":2,
            "OrderType":2,
            "Price":1200000000,
            "Qty":1200000000,
